...
import '../Productpagenext/Productpagenext.css';
...
const Productpagefirst = () => {
  ...
  <div className="row">
    ...
    <>
  {/* center main starts  */}
  <div className="col-6 center-main center-content">
    <div className="container-fluid ">
      <div className=" container-fluid product card ">
        <img src="../images/shoe1.png" alt="shoe1" />
        <div className="shoe-design d-flex  gap-1">
          <img src="../images/Rectangle 2194.png" width="20%" alt="" />
          <img src="../images/Rectangle 2194.png" width="20%" alt="" />
          <img src="../images/Rectangle 2195.png" width="20%" alt="" />
          <img src="../images/Rectangle 2196.png" width="20%" alt="" />
          <img src="../images/Rectangle 2197.png" width="20%" alt="" />
          <img src="../images/Rectangle 2198.png" width="20%" alt="" />
        </div>
        <div className="product-title mt-4 ">
          ...
          <div className="short-description">
            <p>Air Force 1 Shadow Beige Pale Ivory</p>
          </div>
        </div>
        <div className="long-description">
          Eros, parturient sit posuere amet. Sed dignissim enim nulla egestas
          vitae id augue eleifend. Nam commodo scelerisque enim integer risus,
          non ...
          <b>Read more</b>
        </div>
        <div className="product-size d-flex justify-content-between mt-3">
          <div className="size">
            <h4>Size</h4>
          </div>
        ...
        <div className="number">
          <span>37</span>
          <span>38</span>
          <span className="selected text-white">39</span>
          <span>40</span>
          <span>41</span>
          <span>41</span>
        </div>

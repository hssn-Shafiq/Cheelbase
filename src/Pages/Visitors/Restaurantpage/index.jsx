      ...
      <div className="col-lg-9">
        <div className="row">
          <div className="col-lg-4 ">
            <img
              className="group-3img"
              src="../images/Rectangle 5211.png"
              width=""
              alt=""
            />
            <div className="side-two-text ">
              <div className="row">
                {" "}
                <span className="Burger">Burger</span>
                <span className="text">$3.49</span>
              </div>
              <div className="row text-line mt-2">
                <span>This is my whole description for the whole me</span>
              </div>
              <div className="more-btn mt-4">
                <div className="btn">
                  <button className="btn-more-side">more</button>
                </div>
                <div className="img-after-more">
                  <img src="../images/whatsapp-yellow.png" alt="" />

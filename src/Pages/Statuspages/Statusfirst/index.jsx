...
import "../../Productpages/Productpagefirst/"
import '../Statusfirst/Statusfirst.css';
...
const Statusfirst = () => {
  ...
  <div className="row">
    ...
    <div className="col-md center-main">
      <img className="position" src="../images/Group 18308.png" alt="" />
      <img
        className="position2"
        src="../images/Group 18308.png"
        alt=""
      />
      <img
        className="position3"

...
import '../Callingpage/Callingpage.css';
...
const Callingpage = () => {
    return(
      ...
      <>
  {/* center main starts  */}
  <div className="col-9  calling-main ">
    <div className="calling-person mt-3   d-flex">
      <div className="ellipse  mt-3">
      ...
      <div className="person mt-3 ">
        ...
        <div className="col-10 seen">
          <p className=" last-seen">Last seen today at 14:28</p>
        </div>
      </div>
    </div>
    <div className="calling-vicent mt-5">
      <div className="vicent mt-5">
        <img src="../images/Group 18513.png" alt="" />
      </div>
    </div>
    <div className="calling-options   justify-content-center">
    ...
    <div className="continue-next text-center">
        <a href="/Callingmarina"><button className="btn btn-primary">Continue to Next</button></a>
      </div>
  </div>
</>

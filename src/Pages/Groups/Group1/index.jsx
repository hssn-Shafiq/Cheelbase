...
const Group1 = () => {
    ...
    useEffect(() => {
      ...
      // Perform any form processing here
  
      // Navigate to another page
      window.location.href = '/Grouphome'; // Replace with the desired URL
    });
  ...
  <div className="row">
    ...
    <div className="col-md">
      <div className="image p-3 ">
        <img src="../../images/bg-group.png" alt="" width="100%" />
      </div>
      ...
      <div className="my-groups my-channels d-flex align-items-center justify-content-between ">
        <div className="channels-box group-box d-flex gap-2 px-3 py-2">
          <img
            src="../../images/icons/Ellipse 341 (1).png"
            width={50}
            height={50}
            alt=""
            className="rounded-circle"
          />
          <div className="box bg-light box-header p-3 pb-3">
            <div className="title ">
              <h2>Group Name</h2>
              <hr />
              <p>
            ...
            <div className="box-footer mt-3 d-flex align-items-center justify-content-between">
        ...
        <div className="channels-box group-box d-flex gap-2 px-3 py-2 ms-5">
          <img
            src="../../images/icons/Ellipse 341 (1).png"
            width={50}
            height={50}
      ...
      <div className="my-groups my-channels d-flex align-items-center justify-content-between mt-5">
        <div className="channels-box group-box d-flex gap-2 px-3 py-2">
          <img
            src="../../images/icons/Ellipse 341 (1).png"
            width={50}

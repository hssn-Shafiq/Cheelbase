...
import '../Monetizechannel/Monetizechannel.css';
 ...
 const Monetizechannel = () => {
  ...
  <div className="monetize-chats">
    <div className="chat-first">
      <h3 className="col-8 text-danger monetize-one ms-3 mt-2">
    ...
    <div className="channel-id text-center">
      <label htmlFor="channel">Select channel id</label>

...
const VisitorVideoUpload = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const visitorsProfileVideoRef = ref(visitorsProfileRef, 'visitors_profile_video');
  ...
  return (
    <div className="container mt-5 mb-5 text-start">
      <h2 className="mb-4">Visitor Video Uploader</h2>
      <div className="mb-3">
      ...
      <div className="mb-3">
        ...
        <input id="profileImage" className="form-control" type="file" accept="image/*" onChange={handleProfileImageChange} />
      </div>
      <div className="mb-3">
...
export default VisitorVideoUpload;

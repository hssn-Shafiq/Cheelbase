    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="collapsibleNavId">
        ...
        <form className="d-flex  nav-icon">
          ...
          <div className="notifications mt-2 d-flex">
            
            <div className="me-4">
                <a href="">
                <img src="images/icons/stop_screen_share.png" width={20} height={20} className="img-icoon" alt="" />
             </a>
            </div>
            <div className="me-4">
            <a href="">
                <img src="images/icons/add_call (1).png" width={20} height={20} className="img-icoon" alt="" />
            </a>
            </div>
            <div>
            <a href="">
                <img src="images/icons/videocam (1).png" width={20} height={20} className="img-icoon" alt="" />
            </a>
            </div>
          ...
          <div className="lines">
            <li className="dropdown dropstart account-dropdown">
              ...
              >
                ...
                <a className="dropdown-item wallet-items" href="gallery.html">
                  <img
